        ...
        return (
            <section className="header-container">
                ...
                <section className="header-content-container">
                    <img className="header-image" src="img/hilma-house.jpg" />
                    <p className="header-tagline">
                        A soft space to create a modern day survival guide for
                        an ancient psyche of a human being. We’re here to talk
                        about healing modalities that work and don’t work, to
                        consider our surroundings, our commitment, our freedom,
                        and our relationship to everything that is outside and
                        inside of us. A story of a counter-culture protagonist.
                    </p>
                </section>
